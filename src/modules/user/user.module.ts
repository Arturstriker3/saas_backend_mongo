...
import { UserRepositoryMongo, makeUserSchema, UserDoc } from "./infrastructure/user.repository.mongo";
...
@Module({
  ...
  providers: [
    {
      provide: USER_MODEL,
      useFactory: (conn: MongooseConnection) => conn.model<UserDoc>("users", makeUserSchema()),
